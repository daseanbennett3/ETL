...
# In[2]:
#1. Download the orders.csv file from https://www.kaggle.com/datasets/ankitbansal06/retail-orders
...
#1. import SQL Alchemy because its better Pythonicaly than SQL
import sqlalchemy as sal
#2. Create the connection. Use the name "DESKTOP-3MQELCQ" which was found in Microsoft SQL Server Management Studio
